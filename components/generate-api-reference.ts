...
import { BackgroundColor, Slider } from '@/components/_slider'
// import ExampleTSDoc from '@/components/example-tsdoc.mdx'
...
${tags.usage}`,
  ...
  return evaluate(rawJs, components as MDXComponents, { definition })
}
